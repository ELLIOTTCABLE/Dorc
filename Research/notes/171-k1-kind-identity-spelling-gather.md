...
> is `plans/177-k1-kind-identity-map.md`. Sources graded into `../sources.json` via `new-source.sh`.
...
## Front-by-front (neutral; ranking + lean are in plans/177)
...
## Open / next
- Map + lean → `plans/177-k1-kind-identity-map.md` (this round stops at the map; human takes the lean
