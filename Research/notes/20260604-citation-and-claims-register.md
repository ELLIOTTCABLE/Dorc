...
[B-dozer-icse-seip-2022] (16, **DONE-b4 PASS→B**) · [A-harnad-symbol-grounding-1990] (14, **DONE-b4 PASS**; *plan downgraded the analogy's reach, source-grade stands*) ·
...
[B-moller-schwartzbach-static-program-analysis-2025] (8, **DONE-b5 PASS→B** rekey; *textbook, low power; section-numbers exact*) ·
...
- **[B-dozer-icse-seip-2022] → PASS → grade B.** `papers/` migration stub → **staging line emitted (A→B rekey, confirms
...
[B-moller-schwartzbach-static-program-analysis-2025] (8, **A→B rekey per handoff**; textbook, low-power, fuzzy "supports")
...
- **[B-moller-schwartzbach-static-program-analysis-2025] → PASS → grade B.** `papers/` stub → **staging line (A→B rekey, confirms
