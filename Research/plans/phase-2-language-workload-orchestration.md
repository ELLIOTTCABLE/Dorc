...
Three referenceable architectures (detail in `notes/40`): Morbig (Menhir incremental-LR, GPL-3, OCaml), Oils/OSH (recursive-descent + re2c lexer-modes, Apache-2.0), mvdan/sh (hand-rolled, BSD, Go).
