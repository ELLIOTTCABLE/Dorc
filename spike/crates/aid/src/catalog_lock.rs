...
pub const CATALOG: &[CatalogEntry] = &[
    ...
    CatalogEntry {
        ...
        params: &["kind", "count"],
        example: "sm kind 'sm_dorc_Package' has 2 resolvers across oracle files -- at-most-one-resolver-per-kind (24F section 3): BOTH refused, the kind keeps token-equality (never first-wins-silently)",
    ...
    CatalogEntry {
        ...
        params: &["name"],
        example: "sm resolver 'hork.resolve()' is keyed to a name matching a known COMMAND provider -- resolvers are keyed by KIND, not command (corr-kind-keying section 10); this mints identity for a kind no coordinate may use (a likely mis-key)",
    ...
    CatalogEntry {
        ...
        params: &["kind", "count"],
        example: "sm kind 'sm_dorc_Package' has 2 reach-functions across oracle files -- at-most-one-reaches-per-kind (24G section 4): BOTH refused, the kind's footprints do not expand (never first-wins-silently)",
    ...
    CatalogEntry {
        ...
        params: &["name"],
        example: "sm reach-function 'hork.reaches()' is keyed to a name matching a known COMMAND provider -- reaches is keyed by KIND, not command (24G section 4); this expands a kind no coordinate may use (a likely mis-key)",
