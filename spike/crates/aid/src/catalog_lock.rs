...
pub const CATALOG: &[CatalogEntry] = &[
    ...
    CatalogEntry {
        ...
        example: "sm `ä¸\u{ad}pkg` munges to the sh function name `ä¸\u{ad}pkg__predict`, which is not a legal NAME: non-ASCII character `ä` (a NAME admits only ASCII letters/digits/`_`) (ca-munge-charclass, 24M §4b) — REFUSED (a broken function name cannot ship; the munger must transliterate or the name must be renamed)",
        message: Some("sm `{{source}}` munges to the sh function name `{{funcname}}`, which is not a legal NAME: {{problem}} (ca-munge-charclass, 24M §4b) — REFUSED (a broken function name cannot ship; the munger must transliterate or the name must be renamed)"),
        help: None,
    },
    CatalogEntry {
    ...
    CatalogEntry {
        ...
        example: "sm `netns2` is not a known context dimension on a `tolerates:` vouch (expected one of user, fs-view, netns); the mark vouches nothing and the site stays walled on that dimension (`27C` §2).",
        message: Some("sm `{{token}}` is not a known context dimension on a `tolerates:` vouch (expected one of {{expected}}); the mark vouches nothing and the site stays walled on that dimension (`27C` §2)."),
        help: None,
    },
    CatalogEntry {
        ...
        params: &[],
        example: "sm this `is_converged` carries `tolerates:user` but VISIBLY reads the caller's identity (`id`/`$USER`/`$HOME`): are you sure the body is read-only under a user shift, not just answer-varying? A shifted user must not make it MUTATE (`27C` §2 corroboration).",
        message: Some("sm this `is_converged` carries `tolerates:user` but VISIBLY reads the caller's identity (`id`/`$USER`/`$HOME`): are you sure the body is read-only under a user shift, not just answer-varying? A shifted user must not make it MUTATE (`27C` §2 corroboration)."),
        help: None,
    },
    CatalogEntry {
        ...
        params: &[],
        example: "sm this `is_converged` reads the caller's identity but carries no tolerance vouch — a wrapped site (`sudo …`) will run/guard instead of eliding. One line makes it context-shiftable: `: safe-across user` (`27C` §2).",
        message: Some("sm this `is_converged` reads the caller's identity but carries no tolerance vouch — a wrapped site (`sudo …`) will run/guard instead of eliding. One line makes it context-shiftable: `: safe-across user` (`27C` §2)."),
        help: None,
    },
    CatalogEntry {
        ...
        params: &["token", "expected"],
        example: "sm `netns2` is not a known lend_map dimension (expected one of user, netns, fs-view); the line mints no lend and the dimension it meant to answer stays ⊤ (walls). Dimension marks are an engine-owned closed vocabulary (`273` §8).",
        message: Some("sm `{{token}}` is not a known lend_map dimension (expected one of {{expected}}); the line mints no lend and the dimension it meant to answer stays ⊤ (walls). Dimension marks are an engine-owned closed vocabulary (`273` §8)."),
        help: None,
    },
    CatalogEntry {
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "sm verdict and observe marks are single-cell; brace alternation `@{a,b}` is claim-emission-only (`277` §4c) — this mark mints NO cell and the site will run. Split it into one marked probe line per cell.",
        message: Some("sm verdict and observe marks are single-cell; brace alternation `@{a,b}` is claim-emission-only (`277` §4c) — this mark mints NO cell and the site will run. Split it into one marked probe line per cell."),
        help: None,
    },
    CatalogEntry {
    ...
    CatalogEntry {
        ...
        params: &["kind", "count"],
        example: "sm kind 'sm.dorc.Package' has 2 resolvers across oracle files — at-most-one-resolver-per-kind (24F §3): BOTH refused, the kind keeps token-equality (never first-wins-silently)",
        message: Some("sm kind '{{kind}}' has {{count}} resolvers across oracle files — at-most-one-resolver-per-kind (24F §3): BOTH refused, the kind keeps token-equality (never first-wins-silently)"),
        help: None,
    },
    CatalogEntry {
        ...
        params: &["name"],
        example: "sm resolver 'nginx.resolve()' is keyed to a name matching a known COMMAND provider — resolvers are keyed by KIND, not command (corr-kind-keying §10); this mints identity for a kind no coordinate may use (a likely mis-key)",
        message: Some("sm resolver '{{name}}.resolve()' is keyed to a name matching a known COMMAND provider — resolvers are keyed by KIND, not command (corr-kind-keying §10); this mints identity for a kind no coordinate may use (a likely mis-key)"),
        help: None,
    },
    CatalogEntry {
    ...
    CatalogEntry {
        ...
        params: &["kind", "count"],
        example: "sm kind 'sm.dorc.Package' has 2 reach-functions across oracle files — at-most-one-reaches-per-kind (24G §4): BOTH refused, the kind's footprints do not expand (never first-wins-silently)",
        message: Some("sm kind '{{kind}}' has {{count}} reach-functions across oracle files — at-most-one-reaches-per-kind (24G §4): BOTH refused, the kind's footprints do not expand (never first-wins-silently)"),
        help: None,
    },
    CatalogEntry {
        ...
        params: &["name"],
        example: "sm reach-function 'nginx.reaches()' is keyed to a name matching a known COMMAND provider — reaches is keyed by KIND, not command (24G §4); this expands a kind no coordinate may use (a likely mis-key)",
        message: Some("sm reach-function '{{name}}.reaches()' is keyed to a name matching a known COMMAND provider — reaches is keyed by KIND, not command (24G §4); this expands a kind no coordinate may use (a likely mis-key)"),
        help: None,
    },
    CatalogEntry {
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "sm this __is_converged body answers with a pipeline's tail status (oracle-contract §3): the exit status is the LAST stage's, not necessarily the tool-under-description's — prefer a shape where the modeled tool produces the status directly.",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-file-not-found]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-file-permission-denied]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-file-unreadable]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-flag-needs-value]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-flag-requires-mode]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-flag-value-not-a-number]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-flag-value-not-recognized]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-flags-mutually-exclusive]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-no-book-given]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-shim-dir-unwritable]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-strip-got-a-flag]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-strip-needs-path]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-unknown-flag]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-unknown-flag-did-you-mean]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: cli-unknown-mode]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: dorc-sh-exec-failed]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: dorc-sh-script-unreadable]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: dorc-sh-usage]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: lint-file-count-drift]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: lint-no-lintable-files]",
    ...
    CatalogEntry {
        ...
        params: &[],
        example: "[unwritten: lint-required-tools-missing]",
