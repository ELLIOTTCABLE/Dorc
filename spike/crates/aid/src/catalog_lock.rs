...
pub const CATALOG: &[CatalogEntry] = &[
    ...
    CatalogEntry {
        ...
        help: Some("ask the question live instead: `dorc why` (without `--last`) re-analyzes the current book directly"),
    },
    CatalogEntry {
        ...
        help: Some("replaying old decisions against changed files would mislead; re-run `dorc why` live for a current answer"),
    },
    CatalogEntry {
        slug: "whylog-absent",
        ...
        help: Some("a why-log is saved when a plan or apply runs with `--whylog-dir`; run one first, or point `--whylog-dir` at the right directory"),
    },
    CatalogEntry {
        slug: "whylog-corrupt",
        ...
        help: Some("this usually means an interrupted write; re-run `dorc why` live, and the next plan or apply will save a fresh why-log"),
    },
    CatalogEntry {
        ...
        help: Some("load them with `--oracle <file>` (or point `--oracle-dir` at their directory); dorc never loads an oracle you did not name"),
    },
    CatalogEntry {
