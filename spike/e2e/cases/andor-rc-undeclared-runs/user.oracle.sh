...
# effect-map keys on the ε-verb, and the predict() below binds the first operand as the
...
# command-keyed predict(): `useradd <name>` binds NO verb (verbless — the effect-map keys
