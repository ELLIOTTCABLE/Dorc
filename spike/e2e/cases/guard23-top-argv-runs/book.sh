...
# substitution RHS: the value-plane marks PKG TOP, the predict() is never evaluated, no path
# through the predict-body is reached, and the witness cannot form — with or without the
